...
export const SERVER_URL1 = DEV_MODE
  ? "http://localhost:3001"
  : "http://206.189.147.229:3001";
export const USDT_ABI = [
  {
    inputs: [
      { internalType: "address", name: "beneficiaryAddress_", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "uint8", name: "feePercentage_", type: "uint8" }],
    name: "setFeePercentage",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
