            ...
            <Paper>
                <Grid container justifyContent="space-around">
                    ...
                    <Grid item lg={3} md={12} sm={12} className="responsivecard">
                        <Paper sx={{ padding: '20px' }}>
                            <Grid container justifyContent="space-around">
                                <Grid item lg={12} md={12} sm={12} xs={12} sx={{ paddingBottom: '10px' }} className="responsivecard">
                                    <OnlineUserCard />
                                </Grid>
                                <Grid item lg={12} md={12} sm={12} xs={12} sx={{ paddingBottom: '10px' }} className="responsivecard">
                                    <EnteringUserCard />
                                </Grid>
                                <Grid item lg={12} md={12} sm={12} xs={12} className="responsivecard">
                                    <BettingCard />
                                </Grid>
                            </Grid>
                        </Paper>
                        ...
                        <Grid container justifyContent="space-between">
                            <Grid item lg={6} xs={12} sx={{ padding: '10px' }}>
                                ...
                                <Grid container>
                                    ...
                                    <Grid item xs={6} sx={{ padding: '10px' }}>
                                        <TextField id="round-wait" label="Round Time" variant="outlined" fullWidth />
                                    </Grid>
                                </Grid>
                            ...
                            <Grid item lg={6} xs={12} sx={{ padding: '10px' }}>
                                ...
                                <Grid container>
                                    <Grid item xs={6} sx={{ padding: '10px' }}>
                                        <TextField id="round-prediction" label="Get Lastest Price" variant="outlined" fullWidth />
                                    </Grid>
                                    <Grid item xs={6} sx={{ padding: '10px' }}>
                                        <TextField id="round-result" label="Price management" variant="outlined" fullWidth />
                                    </Grid>
                                </Grid>
                                <Grid container justifyContent="center" sx={{ padding: '20px' }}>
                                    <Button />
