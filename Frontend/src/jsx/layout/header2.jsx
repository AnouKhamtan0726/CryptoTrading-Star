...
const AlertToggle = React.forwardRef(({ children, onClick }, ref) => (
    ...
    >
        ...
        <div className="alert_panel">
            <span className="thumb"><i className="mdi mdi-bell-ring"></i></span>
        </div>
    </div>
));
    ...
    >
        ...
        <div className="account-select">
            <div className="select-pointer d-flex justify-content-between align-items-center px-2">
                ...
                <span className="arrow px-2"><i className="la la-angle-down"></i></span>
            </div>
        </div>
    </div>
));
...
const QuickDeposit = React.forwardRef(({ children, onClick }, ref) => (
    ...
    >
        {children}
        <div className="deposit-btn btn btn-info text-white">
            Quick Deposit
        </div>
    </div>
));
                            ...
                            <nav className="navbar navbar-expand-lg navbar-light px-0 justify-content-between">
                                ...
                                <div className="header-right d-flex my-2 align-items-center">
                                    <div className="prize-pool mx-3">
                                        <Link to={'./prize-pool'}>
                                            <img className="prize-icon" src={require('./../../images/main_assets/center.png')} alt="" />
                                            ...
                                            <Dropdown.Menu size="sm" title="">
                                                <div className="live-account d-flex align-items-center justify-content-between py-1 px-3">
                                                    ...
                                                    <div className="live-modal">
                                                        <svg data-v-b495ff56="" xmlns="http://www.w3.org/2000/svg" width="46" height="29" viewBox="0 0 46 29"><g data-v-b495ff56="" id="Group_13378" data-name="Group 13378" transform="translate(-230 -71)"><g data-v-b495ff56="" id="Group_13375" data-name="Group 13375"><g data-v-b495ff56="" id="Group_13376" data-name="Group 13376"><rect data-v-b495ff56="" id="Rectangle_4298" data-name="Rectangle 4298" width="46" height="29" rx="4" transform="translate(230 71)" fill="#34D1D6"></rect></g></g><g data-v-b495ff56="" id="Group_13377" data-name="Group 13377"><g data-v-b495ff56="" id="conversion" transform="translate(246.725 78.133)"><path data-v-b495ff56="" id="Path_13963" data-name="Path 13963" d="M15.692,7.459H1V6.123H14.079L10.072,2.116l.945-.944,5.147,5.147a.668.668,0,0,1-.472,1.14Z" transform="translate(-1 -1.172)" stroke="" class="fill-color"></path><path data-v-b495ff56="" id="Path_13964" data-name="Path 13964" d="M6.342,34.287,1.2,29.14A.668.668,0,0,1,1.668,28H16.359v1.336H3.28l4.007,4.007Z" transform="translate(-1 -19.042)" stroke="" class="fill-color"></path></g></g></g></svg>
                                                    </div>
                                                </div>
                                                <div className="demo-account d-flex align-items-center justify-content-between py-1 px-3">
                                                    ...
                                                    <div className="demo-recharge">
                                                        <svg data-v-b495ff56="" xmlns="http://www.w3.org/2000/svg" width="17.795" height="18.488" viewBox="0 0 17.795 18.488" id="refill-balance"><g data-v-b495ff56="" id="refresh-01" transform="translate(-1 0.081)"><path data-v-b495ff56="" id="Path_26259" data-name="Path 26259" d="M18.8,7.366,17.555-.081,14.993,2.481a8.8,8.8,0,1,0,2.9,10.641.8.8,0,0,0-1.468-.642,7.215,7.215,0,1,1-2.573-8.854l-2.5,2.5Z" fill="#fff"></path></g></svg>
                                                    </div>
                                                </div>
                                            </Dropdown.Menu>
                                        </Dropdown>
                                    ...
                                    <div className="quick-deposit mx-3">
                                        <Dropdown className="deposit-btn">
                                            ...
                                            <Dropdown.Menu size="sm" title="">
                                                <form className='p-3'>
                                                    <p className='text-white mb-1 small-text'>Wallet Balance</p>
                                                    <div className='btn btn-light w-100'>
                                                        <img src={require('./../../images/main_assets/usdt.png')} className="wallet-icon" alt="" />
                                                        <span>100.00</span>
                                                    </div>
                                                    <p className='text-white mb-1 small-text mt-3'>Deposit Amount</p>
                                                    <div className='position-relative'>
                                                        <input type="text" className='form-control deposit-amount w-100' placeholder='Please enter amount' />
                                                        <span className='position-absolute'>All</span>
                                                    </div>
                                                    <p className='text-white mb-1 small-text mt-3'>*Total Receive Amount</p>
                                                    <h3>$150.00</h3>
                                                    <Link className="w-100" to={'./exchange'}><div className="text-white btn btn-success btn-block w-100 mt-3">Deposit Now</div></Link>
                                                    <p className='mb-1 small-text mt-2 text-center'>*Subject to change</p>
                                                </form>
                                            </Dropdown.Menu>
                                        </Dropdown>
                                    </div>
                                                ...
                                                <div className="language dropdown-item">
                                                    <Dropdown>
                                                        ...
                                                        <Dropdown.Menu size="sm" title="">
                                                            ...
                                                            <Link to={'#'} className="dropdown-item">
                                                                <i className="flag-icon flag-icon-ua"></i> український
                                                            </Link>
                                                            <Link to={'#'} className="dropdown-item">
                                                            ...
                                                            <Link to={'#'} className="dropdown-item">
                                                                <i className="flag-icon flag-icon-kr"></i> 한국어
                                                            </Link>
                                                            <Link to={'#'} className="dropdown-item">
                                                                <i className="flag-icon flag-icon-kh"></i> ប្រទេសកម្ពុជា
                                                            </Link>
                                                            <Link to={'#'} className="dropdown-item">
                                                                <i className="flag-icon flag-icon-th"></i> Thai
                                                            </Link>
                                                            <Link to={'#'} className="dropdown-item">
                                                                <i className="flag-icon flag-icon-vn"></i> Tiếng Việt
                                                            </Link>
                                                            <Link to={'#'} className="dropdown-item">
                                                                <i className="flag-icon flag-icon-id"></i> Indonesian
                                                            </Link>
                                                            <Link to={'#'} className="dropdown-item">
                                                ...
                                                <div className='panel-container'>
                                                    <div className="panel-header d-flex justify-content-between align-items-center">
                                                        <div className='d-flex align-items-center'>
                                                            ...
                                                            <span className='mx-2 pointer btn btn-success py-0 px-2 text-white'><i className="mdi mdi-check-all"></i></span>
                                                        </div>
                                                        <div className="btn">
                                                            View All
                                                        </div>
