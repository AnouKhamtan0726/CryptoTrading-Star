            ...
            <div className="col-xl-9">
              <div className="col-xl-12">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p>
                      Fast and easy staking service for Alita holders. Unstake
                      immediately with 10% fee. Standard unstaking completes
                      after 24 hours, free of charge.
                    </p>
                      ...
                      <div className="card-header">
                        <div className="box-title">
                          <img
                            ...
                            className="img-fluid"
                          />
                          <h5 className="stakeali-text">Stake ALI</h5>
                        </div>
              ...
              <div className="col-xl-12">
                <div className="card">
                  <div className="card-header">
                    <h4 className="card-title">Token Info</h4>
                  </div>
                  <Tabs
                    ...
                    <div className="card tokeninfo-card">
                      ...
                      <div className="card-body">
                        <div className="card-content">
                          <img
                            src={require("./../../images/main_assets/tokeninfo1.png")}
                            alt=""
                            className="img-fluid"
                          />
                          <div>
                        ...
                        <div className="card-content">
                          <img
                            src={require("./../../images/main_assets/tokeninfo2.png")}
                            alt=""
                            className="img-fluid"
                          />
                          <div>
                  ...
                  <div className="cryptocard-box">
                    ...
                    <div className="content-line align-items-center">
                      ...
                      <div className="d-flex align-items-center">
                        <div className="crypto-box">
                          <img
                            src={require("./../../images/main_assets/ali-small.png")}
                            width={24}
                            alt=""
                            className="img-fluid"
                          />
                ...
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <h6 className="mb-0">
                      8.552 ALI per USDT{" "}
                      <img
                        src={require("./../../images/main_assets/change.png")}
                        alt=""
                        className="img-fluid"
                      />
                    </h6>
                  </div>
                  <button className="btn btn-success w-100 text-white mt-3">
                    Buy ALI
                  </button>
                </div>
              </div>
