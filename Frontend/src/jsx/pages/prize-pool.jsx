            ...
            <div className="prize-content-body">
                <div className='prize-pool-container'>
                    <div className="prize-intro position-relative">
                        <img src={require('./../../images/main_assets/prizeman1.png')} alt="" className="img-fluid prizeman-img position-absolute" />
                        <h2 className='text-center font-frizon'>
                            Streak Challenge
                        </h2>
                        <div className='d-flex justify-content-center'>
                            <div className="prize-amount position-relative ">
                                ...
                                <img src={require('./../../images/main_assets/prizefire.png')} alt="" className="img-fluid prizefire-img position-absolute" />
                                <img src={require('./../../images/main_assets/prizebox1.png')} alt="" className="img-fluid prizebox1-img position-absolute" />
                                <img src={require('./../../images/main_assets/prizebox2.png')} alt="" className="img-fluid prizebox2-img position-absolute" />
                                <span class="prize-pool-mega-fund">$474.07</span>
                            </div>
                        </div>
                        <div className='text-center mt-5'>
                            <Link className="" to={'./dashboard'}><div className='btn btn-info mt-5 mb-4 px-4 py-2'>Trade & Win Challenge</div></Link>
                    ...
                    <div className="prize-last position-relative">
                        ...
                        <div className='d-flex justify-content-center'>
                            <div className="prize-amount position-relative ">
                                <div className='prize-amount-number text-center'>
                                    HAM***
                                </div>
                                ...
                                <img src={require('./../../images/main_assets/goldbox1.png')} alt="" className="img-fluid prizebox1-img position-absolute" />
                                <img src={require('./../../images/main_assets/goldbox2.png')} alt="" className="img-fluid prizebox2-img position-absolute" />
                                <span class="prize-pool-mega-fund">$420.62</span>
                            </div>
                        </div>
                        <div className='text-center my-5 statistic-table'>
                            <div className="container">
                                <Tabs defaultActiveKey="winning" id="uncontrolled-tab-example" className="mb-3">
                                                            ...
                                                            <table className="table table-striped mb-0 table-responsive-sm">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>989***</td>
                                                                        <td className='win-streak'>Win Streak 9x</td>
                                                                        <td>$94.51</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>big***</td>
                                                                        <td className='lose-streak'>Lose Streak 9x</td>
                                                                        <td>$94.51</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                            ...
                                                            <table className="table table-striped mb-0 table-responsive-sm">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className='lose-streak'>Win Streak 9x</td>
                                                                        <td>$299.99</td>
                                                                        <td>Completed</td>
                                                                    </tr>
                                                                </tbody>
                    ...
                    <div className="prize-help" id='#prize-help'>
                        <img src={require('./../../images/main_assets/roket1.png')} alt="" className="img-fluid prizeroket1-img position-absolute" />
                        <img src={require('./../../images/main_assets/roket2.png')} alt="" className="img-fluid prizeroket2-img position-absolute" />
