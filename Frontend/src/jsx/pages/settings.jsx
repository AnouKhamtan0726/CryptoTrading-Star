                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <form method="post" name="myform" className="personal_validate">
                                                <div className="row">
                                                    <div className="row">
                                                        <div className="mb-3 col-xl-6 col-xs-12">
                                                    ...
                                                    <div className="mb-3 col-xl-6 col-md-6">
                                                        ...
                                                        <input type="text" className="form-control" placeholder="Big Star"
                                                            name="firstname" />
                                                        <p className='small-text text-danger'>* You must enable 2FA to modify this field</p>
                                                    </div>
                                                    <div className="mb-3 col-xl-6 col-md-6">
                                                    ...
                                                    <div className="mb-3 col-xl-3 col-md-3">
